...
public class CrystalSeekbar extends View {
    ...
    public CrystalSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            thumbSize = array.getDimensionPixelSize(R.styleable.CrystalRangeSeekbar_thumb_size, context.getResources().getDimensionPixelSize(R.dimen.thumb_width));
    ...
    public float getThumbWidth() {
        return (leftThumb != null) ? leftThumb.getWidth() : thumbSize;
    }

    public float getThumbHeight() {
        return (leftThumb != null) ? leftThumb.getHeight() : thumbSize;
    }
    ...
    public void apply() {
        ...
        thumbWidth = (leftThumb != null) ? leftThumb.getWidth() : thumbSize;
        thumbHeight = (leftThumb != null) ? leftThumb.getHeight() : thumbSize;
